  ...
  return (
    <div className="px-0 py-16">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
        <div>
          <p className="w-full lg:w-[70%] text-xl font-normal border-l-4 border-black dark:border-white px-6 mt-5">
          ...
          <a href="https://wa.me/2347017181619">
            <Button className="rounded-full mt-10" variant="default">
              <Mail className="h-4 w-4 mr-2" /> Send a mail
            </Button>
          </a>
        </div>
